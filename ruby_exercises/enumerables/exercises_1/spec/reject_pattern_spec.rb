RSpec.describe 'reject pattern' do
  ...
  it 'removes vowels' do
    ...
    letters.each do |letter|
      remaining << letter unless letter.start_with?('a', 'i', 'o', 'e', 'u', 'y')
    end
  ...
  it 'removes numbers' do
    ...
    elements.each do |data|
      not_numbers << data unless data.class != String
    end
  ...
  it 'removes floats' do
    ...
    not_numbers = []
    elements.each do |data|
      not_numbers << data unless data.class == Float 
    end
  ...
  it 'removes arrays' do
    ...
    remaining = []
    elements.each do |data|
      remaining << data unless data.class == Array 
    end
  ...
  it 'removes hashes' do
    ...
    remaining = []
    elements.each do |data|
      remaining << data unless data.class == Hash 
    end
