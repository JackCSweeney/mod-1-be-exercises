RSpec.describe 'Hashes' do
  ...
  it 'test 8' do
    ...
    # store method adds a new key and value to the existing hash if the key doesn't already exist
    expected = {
      "John Steinbeck" => "Grapes of Wrath",
      "Harper Lee" => "To Kill a Mockingbird",
  ...
  it 'test 9' do
   ...
   # if store is used and the key is already in use, it will replace the value with the new
