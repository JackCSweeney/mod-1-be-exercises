...
RSpec.describe 'Arrays' do
  ...
  it 'test 9' do
    ...
    # The above method arguments are (x, y) where x is the start of the slice, y is the length it
    # is slicing.
  ...
  it 'test 14' do
    ...
    # insert method calls for (x, y) arguments where x is postion in array, y is element being added
